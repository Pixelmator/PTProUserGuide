...
### Adjust the lightness, clarity, and texture of an image
...
To adjust the currently selected layer, do one of the following:

* Choose **Format > Color Adjustments > Basic** (from the Format menu at the top of your screen).
* In the [Tools sidebar](https://www.pixelmator.com/support/guide/pixelmator-pro/#glossary), click ![](https://help.pixelmator.com/pixelmator-pro/3.5/assets/English/1581000192000.png) and turn on Basic.
...
* Choose **Insert > Color Adjustments** (from the Insert menu at the top of your screen) and turn on the Basic adjustment in the [Tool Options pane](https://www.pixelmator.com/support/guide/pixelmator-pro/#glossary).
* Click ![](https://help.pixelmator.com/pixelmator-pro/3.5/assets/English/1648724547000.png) at the top of the [Layers sidebar](https://www.pixelmator.com/support/guide/pixelmator-pro/#glossary), choose Color Adjustments, and turn on the Basic adjustment.
...
Turn on texture-aware algorithm for Shadows, Highlights, Exposure, and Brightness

Texture-aware algorithm is turned off by default. You can turn it on in a couple of simple ways:

* Click More ![](https://help.pixelmator.com/pixelmator-pro/3.5/assets/English/1603810631000.png) at the top of the Color Adjustments pane and choose Use texture-aware algorithm.
* Drag Clarity or Texture sliders, or adjust clarity and texture using the [Selective Clarity](https://www.pixelmator.com/support/guide/pixelmator-pro/1451) adjustment.

**Important:** If you turn on the texture-aware algorithm for documents that have been edited using older versions of Shadows, Highlights, Exposure, and Brightness adjustments, your images may look different.
...
The machine learning-powered Basic adjustment improves the lighting in your image automatically. Click ML in the [Tool Options pane](https://www.pixelmator.com/support/guide/pixelmator-pro/#glossary) next to the Basic adjustment to apply it.
