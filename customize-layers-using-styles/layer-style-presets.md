...
3. Do any of the following:&#x20;
   ...
   * _Share a style preset: To share a style preset with others or use it in Pixelmator Pro on another Mac, d_rag and drop a preset from the list of layer style presets onto the desktop or into a Finder window, then share the _.layerstyles_ file with someone else via email or any other way you like.
